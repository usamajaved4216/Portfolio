    ...
    <>
      <div id="about" style={{ paddingBottom: '50px' }}>
        ...
        <div style={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: '5%' }}>
          <div className='aboutTopLogo' data-aos="flip-right" style={{ width: '250px', height: '250px', textAlign: 'center' }}>
        ...
        <div className='about-main-div' style={{
          ...
          <div className='about-text-div' data-aos="fade-right" style={{ margin: '10% 0 0 5%', }}>
          ...
          <div className='aboutBottomLogo' data-aos="flip-right" style={{ width: '250px', height: '250px', margin: '5% 5% 0 0', textAlign: 'center' }}>
            <img src={itsMe} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%' }} alt="My Image" />
            <h2>usama <span>Javed</span></h2>
            <h4>MERN Stack Developer</h4>
          </div>
        ...
        <div data-aos="slide-up" style={{ textAlign: 'center', marginTop:'10%' }}>
